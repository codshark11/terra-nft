...
contract ERC721 is IERC721, Ownable, ReentrancyGuard {
    ...
    function approve(address to, uint256 tokenId) external override {
        ...
        require(_msgSender() == owner || _operatorApprovals[owner][_msgSender()], "ERC721: approve caller is not owner nor approved for all");
